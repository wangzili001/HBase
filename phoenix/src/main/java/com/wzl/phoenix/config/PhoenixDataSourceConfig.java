package com.wzl.phoenix.config;

import com.wzl.phoenix.mybatis.HikariDataSourceFactory;
...
public class PhoenixDataSourceConfig {
    static final String PACKAGE = "com.wzl.phoenix.**";
    ...
    public DataSource phoenixDataSource() throws Exception{
        ...
        for (Object key : keys) {
            if(key.toString().startsWith("datasource")){
                dsProperties.put(key.toString().replace("datasource.", ""), properties.keys());
            }
        }
